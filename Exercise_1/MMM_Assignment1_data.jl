...
# Time, wind, PV
SE_data=CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[1,4,5])
DE_data=CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[1,2,3])
DK_data=CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[1,6,7])

load_SE = CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[10])
load_DE = CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[8])
load_DK = CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[9])
...
inflow = CSV.read("C:/Users/nilsh/OneDrive/Skrivbord/TimeSeries.csv", select=[1,11])
