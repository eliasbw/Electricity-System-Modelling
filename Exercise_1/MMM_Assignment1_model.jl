...
function build_model_exercise34(;I = 1:6)
  ...
  transmission_power_con = @constraint(m, [ci2 in CI, t in T], power[ci2, 6, t] == efficiencies[6]*sum(transmission[:, ci2, t]))
  transmission_self_con = @constraint(m, [ci in CI, t in T], transmission[ci,ci,t] == 0)
